...
candidates.map((candidate) => {
  const {fullName,registrationDate,location,languageType,stackType,englishLevelType,hr, hrReview,
    interviewer,
    interviewerReview,mentor,mentorReview,statusType} = candidate
  return {
    "Full Name": fullName,
