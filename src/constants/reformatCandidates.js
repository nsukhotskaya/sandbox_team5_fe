...
export const reformatCandidates = (candidates) =>
  candidates.map((candidate) => {
    ...
    return { ...candidate, hr: hrName, interviewer: interviewerName, registrationDate: registrDate , hrReview: hrFeedback, interviewerReview : interviewerFeedback, fullName: `${candidate.firstName} ${candidate.lastName}`};
  });
